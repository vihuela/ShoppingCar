...
public class ShopingCarFrg4Culture extends Fragment implements IShopingCar {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (getView() != null) {
            ...
            DividerDecoration decor = new DividerDecoration(getActivity());
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    GoodsItem item = (GoodsItem)listView.getAdapter().getItem(position);
                    ((ShoppingCartActivity)getActivity()).showBottomSheetForDetail(item.name);
                }
            });
        }
